...
export LIBSHELL_ROOT_PATH=$(realpath "${PWD}/../libShell")
echo "LIBSHELL_ROOT_PATH: ${LIBSHELL_ROOT_PATH}"
...
usage_func()
{
    ...
    echoY "eg:\n./run.sh -c install -l \"atom\""
    echoY "eg:\n./run.sh -c install -l \"repo,atom\""
